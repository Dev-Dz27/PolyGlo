...
const Header = ({
  ...
  useEffect(() => {
    setcurrentLang(params.lang)
      setCurrentCountry(params.country)
  ...
  return (
    <header
      ...
      id="header"
    >
      <div className="mx-auto w-full max-w-6xl px-3 py-3 md:flex md:justify-between md:px-4 md:py-3.5">
              ...
              <div className="ml-4 flex w-max flex-wrap justify-end">
                {actions.map(({ label, href, type }, index) => (
                  <Link
                    ...
                    className={`btn m-1 w-fit px-5 py-2 text-sm font-semibold shadow-none sm:mb-0 md:px-6
                      ${
                        type === "ghost"
                          ? "btn-ghost"
                          : type === "primary"
